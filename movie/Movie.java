...
public class Movie {
	...
	Movie(String title, String director, String[] actors, String genre, int runningTime, 
			Date openningDate, double grade) {
	...
	String arrToString(String[]arr) {	// 배우 목록이 배열이므로, 문자열로 반환해야 출력할 수 있다
		String result = "";
