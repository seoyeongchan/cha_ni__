...
public class Ex06 {	// ex06이라는 객체를 생성하지 않았지만 main 함수에 접근할 수 있어야 하기 때문에 static이 붙는다
...
//		Human 클래스의 count 필드는 정적필드이므로, 정적인 방법으로 접근해야합니다
//		다시말해, 객체.필드 방식이 아니라, 클래스.필드로 접근하는 것이 올바른 방법입니다
